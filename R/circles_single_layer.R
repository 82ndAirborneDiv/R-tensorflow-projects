# =========================================================================== #
# Single layer FF neural network classification of circular groupings         #
# (Not really) Adapted from the wonderful Tensorflow Cookbook by Nick McClure #
# =========================================================================== #

# NOTE: This is just me messing around. I wanted to get an intuition of the
# limitation of classifying embedded groupings with a simple topology.
